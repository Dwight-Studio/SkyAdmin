...
import static fr.skynnotopia.skyadmin.Report.getPlayerActiveSentReports;
import static fr.skynnotopia.skyadmin.Warn.getPlayerWarns;
import static fr.skynnotopia.skyadmin.commands.CommandReports.notifyReport;
...
public class CommandWarn implements CommandExecutor {
    ...
    public boolean onCommand(CommandSender csender, Command command, String label, String[] args) {
        ...
        switch(getPlayerWarns(player).size()) {
            default:
